...
export default withApiAuthRequired(async function handler(req, res) {
  ...
  const response = await openai.createChatCompletion({
    ...
    messages:[
      {
        role:"system",
        content: "You arw an SEO friendly blog post generator called BlogStandard. You are designed to output markdown without frontmatter."
      },
      {
        role:"user",
        content:`
  ...
  const seoResponse = await openai.createChatCompletion({
    ...
    messages:[{
        role:"system",
        content: "You arw an SEO friendly blog post generator called BlogStandard. You are designed to output JSON. Do not include HTML tags in your output",
      },
      {
        role:"user",
        content:`
